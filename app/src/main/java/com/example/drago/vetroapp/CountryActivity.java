...
//        countryPicker =
//                new CountryPicker.Builder().with(CountryActivity.this)
//                        .listener(CountryActivity.this).build();
...
//                if (country == null) {
//                    Toast.makeText(CountryActivity.this, "Country not found", Toast.LENGTH_SHORT).show();
//                } else {
...
//        Intent intent = new Intent(CountryActivity.this, ResultActivity.class);
...
//            countryPicker.showBottomSheet(CountryActivity.this);
//        } else {
//            countryPicker.showDialog(CountryActivity.this);
//        }
//    }
//
