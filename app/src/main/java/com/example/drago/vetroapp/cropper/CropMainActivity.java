...
public class CropMainActivity extends AppCompatActivity {
  ...
  public void setCurrentFragment(CropMainFragment fragment) {
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    ...
    inflater.inflate(R.menu.cropper_main, menu);
    return true;
  }
...
//        Toast.makeText(this, "select oval", Toast.LENGTH_SHORT).show();
...
//        break;
  ...
  private void setMainFragmentByPreset(CropDemoPreset demoPreset) {
    ...
    fragmentManager
        .beginTransaction()
        .replace(R.id.crop_container, CropMainFragment.newInstance(demoPreset))
        .commit();
  }
...
//                .getString(R.string.drawer_option_toggle_shape, options.cropShape.name()));
    ...
    ((TextView) findViewById(R.id.drawer_option_toggle_max_zoom))
        .setText(getResources().getString(R.string.drawer_option_toggle_max_zoom, options.maxZoomLevel));
  }
}
