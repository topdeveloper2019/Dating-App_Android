...
public final class CropMainFragment extends Fragment
  ...
  public static CropMainFragment newInstance(CropDemoPreset demoPreset) {
  ...
  public void updateCurrentCropViewOptions() {
    ...
    ((CropMainActivity) getActivity()).setCurrentOptions(options);
  }
...
//      Toast.makeText(getActivity(), "rotate done", Toast.LENGTH_SHORT).show();
...
//    }
  ...
  public void onAttach(Activity activity) {
    ...
    ((CropMainActivity) activity).setCurrentFragment(this);
  }
